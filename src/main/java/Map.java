public class Map {
    public Room buildMap() {
        ...
        Room room1 = new Room("Room 1", "A room with no distinct features, except two doors.","sword");
        Room room2 = new Room("Room 2", "A dimly lit room with a musty smell.", "dagger");
        ...
        // Create the starting room with an item
